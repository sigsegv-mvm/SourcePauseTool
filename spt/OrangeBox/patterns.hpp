...
namespace Patterns
{
	...
	{
		{
			"BMS-Retail",
			{
				0x8B, 0x0D, '?', '?', '?', '?', 0x83, 0xC4, '?', 0x8B, 0x01, 0x8B, 0x40, 0x28, 0xFF, 0xD0, 0xD9, 0x15, '?', '?', '?', '?', 0xD9, 0x05, '?', '?', '?', '?', 0xDF, 0xF1, 0x77, 0x11, 0xF3, 0x0F, 0x10, 0x05, '?', '?', '?', '?', 0x0F, 0x2F, 0x05, '?', '?', '?', '?', 0x76, '?'
			},
			"xx????xx?xxxxxxxxx????xx????xxxxxxxx????xxx????x?"
		},
	...
	const MemUtils::ptnvec ptnsDemo_TogglePause =
	{
		{
			"BMS-Retail",
			{
				0x8B, 0x0D, '?', '?', '?', '?', 0x8B, 0x01, 0x8B, 0x40, 0x18, 0xFF, 0xD0, 0x84, 0xC0, 0x74, 0x29, 0x8B, 0x0D, '?', '?', '?', '?', 0x8B, 0x01, 0x8B, 0x40, 0x1C, 0xFF, 0xD0, 0x8B, 0x0D, '?', '?', '?', '?', 0x84, 0xC0, 0x8B, 0x01, 0x74, 0x03, 0xFF, 0x60, 0x40, 0xD9, 0x05, '?', '?', '?', '?', 0x51, 0xD9, 0x1C, 0x24, 0xFF, 0x50, 0x34, 0xC3
			},
			"xx????xxxxxxxxxxxxx????xxxxxxxxx????xxxxxxxxxxx????xxxxxxxx"
		}
	};
